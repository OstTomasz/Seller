...
import { assignUserToPosition, buildAssignableUserOptions } from "./positionUser.helpers";
...
export const EditPositionModal = ({ position, availableUsers, onClose }: Props) => {
  ...
  const handleAssign = () => {
    ...
    assignUserToPosition(assignUser, selectedUserId, position._id, {
      onSuccess: () => {
          ...
          {holder ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <Select
                ...
                options={buildAssignableUserOptions(availableUsers)}
              />
