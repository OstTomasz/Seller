...
| 1.4  | Redirect to /change-password when mustChangePassword=true     | 🔲  | 🔲  | ✅   | ✅   | Wymaga resetu hasła przez EditUserModal |
| 1.5  | Force password change — walidacja on blur (nie on type)       | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE                              |
| 1.6  | Force password change — passwords don't match → error on blur | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE                              |
| 1.7  | Force password change — valid submission → redirect /         | 🔲  | 🔲  | ✅   | ✅   |                                         |
| 1.8  | Logout clears session → redirect /login                       | ✅   | ✅   | ✅   | ✅   |                                         |
| 1.9  | Sesja per zakładka — dwie zakładki = dwie niezależne sesje    | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE                              |
...
| 2.5  | Notification bell w topbarze (prawy róg, przed logout) — liczba nieprzeczytanych | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE      |
| 2.6  | 404 page — stylowo pasuje do layoutu                                             | 🔲  | 🔲  | 🔲  | 🔲  | DO DOPRACOWANIA |
| 2.7  | Page transitions                                                                 | ✅   | ✅   | ✅   | ✅   |                 |
| 2.8  | Mobile sidebar                                                                   | ✅   | ✅   | ✅   | ✅   |                 |
| 2.9  | Max-width na tablicach clients/archive na desktopie                              | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE      |
| 2.10 | Max-width na kalendarzu na desktopie                                             | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE      |
| 2.11 | Max-width na notifications na desktopie                                          | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE      |
...
| ---- | ------------------------------------------------------------------ | --- | --- | --- | --- | ---------- |
| 5.1  | Modal opens                                                        | 🔲  | 🔲  | ✅   | ✅   |            |
| 5.2  | Salesperson select — walidacja wymagana (inline, nie toast)        | 🔲  | 🔲  | 🔲  | N/A | NAPRAWIONE |
| 5.3  | NIP — walidacja on blur                                            | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 5.4  | NIP duplicate — sprawdza per handlowiec                            | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 5.5  | NIP w archiwum — unarchive request jeśli należał do tego handlowca | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 6.6  | Add address — postal code auto-format            | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 6.7  | Add/edit address                                 | ✅   | ✅   | ✅   | ✅   |            |
| 6.8  | Delete address — confirm dialog                  | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 6.9  | Delete address — brak przycisku gdy 1 adres      | ✅   | ✅   | ✅   | ✅   |            |
| 6.10 | Add/edit/delete contact                          | ✅   | ✅   | ✅   | ✅   |            |
| 6.11 | Delete contact — confirm dialog                  | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 6.22 | Sekcja inactivity reason USUNIĘTA                | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 7.8  | "Request archive" NIE jest disabled po unarchive | 🔲  | 🔲  | N/A | 🔲  | NAPRAWIONE — flaga zdejmowana przy unarchive |
...
| 8.7  | InviteUsers — ukrywa userów bez pozycji i zarchiwizowanych | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 8.15 | Conflict detection on edit/drag → toast                    | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 8.16 | Copy event — kopiuje też listę zaproszonych                | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
| 8.17 | Accept invitation — sprawdza konflikty                     | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 9.5  | Detail modal                                                  | ✅   | ✅   | ✅   | ✅   |            |
| 9.6  | Link do powiązanego klienta                                   | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 9.11 | Event conflict notification przy akceptacji                   | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 10.5 | Region collapse/expand z animacją | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE |
...
| 11.3  | Avatar / workplace / about aktualizuje się bez przeładowania | 🔲  | 🔲  | 🔲  | 🔲  | NAPRAWIONE — staleTime obniżony                        |
...
| 11.11 | Position history: assignedAt → removedAt                     | 🔲  | 🔲  | N/A | N/A | Seed nie tworzy historii — test po ręcznym przypisaniu |
...
| 14.3  | Search by name (nie email)                            | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.4  | Pagination                                            | ✅   | ✅   | N/A | N/A |            |
| 14.5  | Click user → EditUserModal                            | ✅   | ✅   | N/A | N/A |            |
| 14.6  | EditUserModal — name / email / phone (z walidacją)    | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.7  | EditUserModal — grade dla ADV/SP                      | ✅   | ✅   | N/A | N/A |            |
| 14.8  | EditUserModal — reset password (temp + flaga)         | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.9  | EditUserModal — notes (add/delete z confirmem)        | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.10 | EditUserModal — archive button                        | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.11 | Create user — required fields z walidacją tel         | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 14.12 | Create user — DEP widzi tylko własne vacant positions | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
...
| 15.3 | Create region — superregion required           | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
...
| 15.7 | Delete region — visible jeśli brak pracowników | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 15.8 | Delete region — blocked jeśli są pracownicy    | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
| 15.9 | Delete region — confirm dialog                 | 🔲  | 🔲  | N/A | N/A | NAPRAWIONE |
...
| 16.2 | Breadcrumbs: Archive → Company name             | 🔲  | N/A | N/A | N/A | NAPRAWIONE |
...
| 16.6 | Unarchive — client active, archiveRequest reset | 🔲  | N/A | N/A | N/A | NAPRAWIONE |
...
| 17.5 | Unarchive user (DO ZROBIENIA)           | 💬  | N/A | N/A | N/A | Not yet built |
...
| 18.7  | Loader during fetch                         | 🔲  | 🔲  | 🔲  | 🔲  | Test przez throttling |
